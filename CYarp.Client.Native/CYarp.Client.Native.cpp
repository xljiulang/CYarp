...
int main()
{
	...
	options.ServerUri = (char*)"http://localhost\0";
	options.TargetUri = (char*)"http://www.taichuan.com/\0";
	...
	TransportError error = TransportError::NoError;
	while (error == TransportError::NoError)
	{
