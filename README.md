...
| ---------- | ------------- | ------------------- | -------------------------- |
| CYarp      | -c 10 -n 2000 | 431.21              | P95=29 P99=31              |
| frp_0.56.0 | -c 10 -n 2000 | 316.49              | P95=42 P99=47              |
| CYarp      | -c 20 -n 2000 | 416.62              | P95=56 P99=62              |
| frp_0.56.0 | -c 20 -n 2000 | 284.93              | P95=94 P99=107             |
| CYarp      | -c 50 -n 5000 | 428.54              | P95=124 P99=128            |
| frp_0.56.0 | -c 50 -n 5000 | 259.57              | P95=276 P99=331            |

CYarp和frp的在同一个机器上进行同时部署，压测时ab也在同一个机器上，压测顺序为表格上到下的参数顺序，压测结束后内存占用如下
| 产品        | 峰值工作内存 | 内存   |
| ----------- | ------------ | ------ |
| CYarpServer | 162,336      | 52,168 |
| CYarpClient | 60,956       | 10,992 |
| frps_0.56.0 | 33,884       | 12,704 |
| frpc_0.56.0 | 31,364       | 8,700  |
